          ...
          {activeSection === 'welcome' && (
            <>
              ...
              {user?.user_metadata?.username && (
                      <div className="text-2xl font-semibold text-gray-800 mb-2 break-words whitespace-normal">Hi, {user.user_metadata.username}!</div>
                    )}
                  ...
                  <div className="flex-shrink-0 w-full md:w-auto md:ml-8 mt-6 md:mt-0 flex justify-end">
                    <WeatherWidget />
                  </div>
                </div>
                {!examDate && (
