        ...
        <div className="max-w-[400px] w-full bg-white/80 backdrop-blur-sm p-4 sm:p-8 rounded-2xl shadow-[0_8px_32px_0_rgba(0,97,155,0.15)] border border-white/20 transition-all duration-300 hover:shadow-[0_12px_48px_0_rgba(0,97,155,0.25)]">
          ...
          <form className="space-y-6" onSubmit={handleSignUp}>
            ...
            <div className="relative mb-4">
              ...
              />
              <label htmlFor="username" className="absolute left-3 top-2 text-gray-400 text-[14px] transition-all duration-200 pointer-events-none peer-focus:-top-3 peer-focus:text-xs peer-focus:text-edx-light-blue peer-placeholder-shown:top-2 peer-placeholder-shown:text-[14px] peer-placeholder-shown:text-gray-400 peer-focus:font-medium peer-focus:bg-white px-1">
                Public Username
              </label>
            </div>
            <div className="relative mb-4">
            ...
            <div className="relative mb-4">
              ...
              />
              <label htmlFor="confirmPassword" className="absolute left-3 top-2 text-gray-400 text-[14px] transition-all duration-200 pointer-events-none peer-focus:-top-3 peer-focus:text-xs peer-focus:text-edx-light-blue peer-placeholder-shown:top-2 peer-placeholder-shown:text-[14px] peer-placeholder-shown:text-gray-400 peer-focus:font-medium peer-focus:bg-white px-1">
                Confirm Password
              </label>
              <button
                type="button"
